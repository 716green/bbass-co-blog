...
const checkActive = (path: string = "/") => {
  ...
  const currentClass = path === currentPath ? activeClass : defaultClass;
  return [currentClass, baseClass].join(" ");
};
</script>
<template>
  <nav>
        ...
        <div class="relative flex items-center justify-between h-16">
          <div class="flex items-center px-2 lg:px-0">
            <div class="flex-shrink-0">
              <div class="block lg:hidden h-8 w-auto text-white">∫</div>
              <div class="hidden lg:block h-8 w-auto text-white">∫</div>
            </div>
            <div class="hidden lg:block lg:ml-6">
              <div class="flex space-x-4">
                <a href="/" :class="checkActive('/')"> Dashboard </a>
                <a href="/new" :class="checkActive('/new')"> New </a>
                <a href="/entries" :class="checkActive('/entries')">
                  Entries
                </a>
                <a href="/timeline" :class="checkActive('/timeline')">
                  Timeline
                </a>
              </div>
            </div>
